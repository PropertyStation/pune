    ...
    <footer className='text-gray-900 bg-white mt-10'>
      <div className='max-w-6xl mx-auto px-5 flex flex-wrap flex-col md:flex-row  justify-between gap-8'>
        ...
        <div className='flex flex-col items-start'>
          <img src={logo} alt='' className='w-40 mb-3' />
        </div>

        {/* Contact Us */}
        <div className='flex items-start space-x-3'>
          {/* Icon on the left */}
          <div className='w-10 h-10 flex items-center justify-center rounded-full bg-[#034EA1] text-gray-100 text-xl'>
            <FaPhoneAlt />
          </div>
          ...
          <div className='flex flex-col'>
            {/* Contact Us heading */}
            <h3 className='text-xl font-semibold text-[#034EA1]'>Contact Us</h3>

            {/* Phone number & email in a column under "Contact Us" */}
            <p className='text-[#034EA1] text-sm mt-1'>+918505990055</p>
            <span className='text-[#034EA1] text-sm'>leads@gurugram-property.com</span>
          </div>
        </div>
        ...
        {/* <div className='flex items-start space-x-3'> */}
          ...
          {/* Text content on the right */}
          {/* <div className='flex flex-col'>
            <h3 className='text-xl font-semibold text-[#034EA1]'>Location</h3>

            <p className='text-[#034EA1] text-sm'>
        ...
        <div className='flex flex-col items-start ml-[50px]'>
          <h3 className='text-xl font-semibold mb-3 text-[#034EA1]'>
            Follow Us
          </h3>
          <div className='flex space-x-4'>
            ...
            >
              <div className='w-10 h-10 flex items-center justify-center rounded-full bg-[#034EA1] text-white text-2xl'>
                <FaFacebook />
              </div>
            </a>
            <a
      ...
      {/* Copyright Section */}
      <div className="text-center  bg-gradient-to-r from-[#0088CF] to-gray-500 text-gray-300 text-[10px] mt-6 border-t border-gray-300 pt-4">
        <p> Marketed By - Authorised Channel Partner | Haryana RERA Regd NO.  A52000293981,<br />
