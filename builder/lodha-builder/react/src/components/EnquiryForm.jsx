  ...
  return (
    ...
    <div className="max-w-lg">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[400px] mb-10">
        ...
        <form action="Lodha.php" method="POST"  className="flex flex-col gap-3 pb-4">
          <input
            type="text"
            name="name"
            placeholder="Name"
          ...
          <button
            type="submit"
            className="bg-[#A18422] text-white px-4 py-2 h-10 rounded-md hover:bg-[#A18422] transition"
          >
            Submit
          </button>
        </form>
