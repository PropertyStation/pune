...
const properties = {
  'East Pune': [
    ...
    },
    {
      ...
      bhk: '2, 3 & 4 BHK',
      price: '₹ 83.90 Lacs*',
      redirectUrl:'https://pune-properties.co/gera-joy-on-the-treetops'
    ...
    },
    {
      ...
      bhk: '1, 2, 3 & 4 BHK',
      price: '₹ 0.95 Cr*',
      redirectUrl:'https://pune-properties.co/birla-estates-wellesley-road'
    ...
    },
    {
      ...
      bhk: '2, 3 & 4 BHK',
      price: '₹ 1.26 Cr*',
      redirectUrl:'https://pune-properties.co/majestique-evolvus'
    },
    {
      id: 5,
      image: image5,
      ...
      bhk: '1, 2 & 3 BHK',
      price: '₹ On Request*',
      redirectUrl:'https://pune-properties.co/godrej-skygreens'
    },
    {
      id: 6,
      image: image6,
      ...
      bhk: '3 & 4 BHK',
      price: '₹ On Request*',
      redirectUrl:'https://pune-properties.co/mantra-one-residence'
    },
    {
      id: 7,
      image: image6,
      ...
      bhk: '2, 3 & 4 BHK',
      price: '₹ 1.26 Cr*',
      redirectUrl:'https://pune-properties.co/mantra-riverside'
    ...
    },
    {
      ...
      bhk: '2 & 3 BHK',
      price: '₹ 1.15 Cr*',
            redirectUrl:'https://pune-properties.co/mantra-joypin'
    },
  ],
  'Central Pune': [
    {
  ...
  'West Pune': [
    {
      ...
      bhk: '1, 2 & 3 BHK',
      price: '₹ 59.99 Lacs*',
      redirectUrl:'https://pune-properties.co/godrej-evergreen-square/'
    ...
    },
    {
      ...
      bhk: '2 & 3 BHK',
      price: '₹ 3.8 Cr',
      redirectUrl:'https://pune-properties.co/codename-trendy-west'
    ...
    },
    {
      ...
      bhk: '3 & 4 BHK',
      price: '₹ On Request* ',
      redirectUrl:'https://pune-properties.co/villas-palladio-balewadi-central'
...
const TrendingProject = () => {
  const [selectedCity, setSelectedCity] = useState('East Pune')
  ...
  return (
    <>
      ...
      >
        ...
        {isFormOpen && (
          <div className='fixed inset-0 backdrop-blur-md bg-white/5 flex items-center justify-center  bg-opacity-50 z-50'>
